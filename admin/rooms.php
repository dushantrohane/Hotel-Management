                ...
                while($row = mysqli_fetch_assoc($query_run)){
                    ?>
                        ...
                        <div class="card-body">
                            ...
                            <a href="#" onclick="bookRoom('<?php echo $row['room_no']; ?>', 'a');" class="btn btn-primary <?php if($row["status"]==0){echo "active";}else{echo "disabled";}?>" role="button" aria-disabled="<?php if($row['status']==0){echo "false";}else{echo "true";}?>">Book</a>
